...
function Modulo() {
  return (
    <section className="size-full">
      <div className="relative flex flex-col justify-center items-centertext-white hover:text-black hover:text-xl">
        <Image
      ...
      <footer className="pt-5">
        <div className="flex justify-between items-center">
          <h1 className="font-Montserrat font-semibold text-[24px] max-w-[600px]">
            Introducción a los algoritmos recursivos de python
          </h1>
